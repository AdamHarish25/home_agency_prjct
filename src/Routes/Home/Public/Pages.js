    ...
    <div className={className.container}>
      <div className={className.showcase}>
        ...
        <div className={className.gridList}>
          ...
          ).slice(0, (viewport.innerWidth < 1024 ? 3 : 4)).map((data, idx) => (
            <div
              key={idx}
              className={`${
      ...
      <div className={className.banner}>
        <img
          src={Data.banner.img1}
          className={className.bannerImg1}
        />
        <div className={className.bannerContent}>
          ...
          <Link className={className.bannerLink}>
            {Data.banner.button}
          </Link>
        </div>
        <img
          ...
          {Data.list.map((data, index) => (
            <div key={index} className={className.card}>
              <p className="flex items-center justify-start gap-3">
                <h1 className="text-7xl font-bold">{data.date}</h1>
              ...
              <h5 className="flex items-center gap-2">
                <FaClock className="text-light-accent" /> {data.timeDuration}
              </h5>

              <hr className="border-dark-gray" />

              <div className="space-y-4 pr-10 xl:pr-20">
                <h1 className="text-xl font-semibold">{data.title}</h1>
                <p>{data.subtitle}</p>
              </div>

              <Link className="block w-fit" to={data.button.link}>
                {data.button.title}
              </Link>
            </div>
          ))}
              ...
              <div className={className.cardBox}>
                ...
                >
                  <div className={className.imgCard}>
                    <img draggable={false} src={data.img} alt={data.name}  className="object-contain"/>
                  </div>
